...
MCNearbyServiceBrowserDelegate {
  ...
  func sendMessageToPeerId(peerId: MCPeerID, message: AnyObject) -> NSError? {
  ...
  func sendImageToPeerId(peerId: MCPeerID, imageURL: NSURL, imageName: String) {
